...
BUCKET_NAME = "zoomcamp_taxi_data_bucket"
...
# Since I'm logging in with the SDK, I'm replacing this section with the following line.
client = storage.Client(project='awesome-icon-484918-n5')
