...
In my project, I tried to solve this problem using two methods: Solution with Kestra and Solution with Export without Kestra. You can examine file Solution with Kestra.md for Solution with Kestra and file Solution with Export without Kestra.md for Solution with Export without Kestra.
